define(['../options', 'logger', 'invoke'], function (Options, Logger, Invoke) {
    function ClientDatabaseNamesTest() {
        this.execute = function (aOnSuccess, aOnFailure) {
            Options.with(function (aClient, aOnComplete) {
                ...
                var mIterable = aClient.databaseNames();
                function firstTest() {
                    mIterable.first(function (aName) {
                        Logger.info('databaseName - ' + aName);
                ...
                function forEachTest() {
                    mIterable.forEach(function (aName) {
                        Logger.info('databaseName - ' + aName);
                    }, function () {
    ...
    return ClientDatabaseNamesTest;
});